...
<head>
    ...
    <!-- MetisMenu CSS -->
    {{HTML::style('bootstrap/css/plugins/metisMenu/metisMenu.min.css')}}
    <!-- Timeline CSS -->
    {{HTML::style('bootstrap/css/plugins/timeline.css')}}
    <!-- Custom CSS -->    
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">POS L4</a>
            </div>
            <!-- /.navbar-header -->
    ...
    {{HTML::script('bootstrap/js/plugins/morris/morris.min.js')}}  
