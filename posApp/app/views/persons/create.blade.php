    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <i class="glyphicon glyphicon-plus"> <strong>Agregar</strong></i> 
            </div>
            {{ HTML::ul($errors->all()) }}
                ...
                <div class="row">
                    <div class="col-lg-6 col-lg-offset-3"> 
                        <div class="form-group">
                            ...
                            {{ Form::select('personType', $personTypes, null, array('class' => 'form-control')) }}            
                                             
                        </div> 

                        <div class="form-group">
                            {{ Form::label('identificacion', 'Identificación') }}                                
                            {{Form::text('nip', Input::old('nip'), array('class' => 'form-control', 'required' => 'true'))}}              
                        </div>
